...
fdescribe('#core #webpadize convertBeneficiaries', () => {
  ...
  it('should return an array with `webpadPost`s beneficiaries with correctly calculated weights', () => {
    const beneficiaries = convertBeneficiaries([
...
fdescribe('#core #webpadize withBeneficiaries', () => {
