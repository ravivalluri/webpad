...
fdescribe('#core #webpadize getCustomJsonMetadata', () => {
  ...
  it('should return an empty string if only properties managed by webpads metadata creator are provided', () => {
    const customMetadata = getCustomJsonMetadata(
  ...
  it('should return custom metadata if NOT only properties managed by webpads metadata creator are provided', () => {
    const customMetadata = getCustomJsonMetadata(
  ...
  it('should return custom metadata if only properties NOT managed by webpads metadata creator are provided', () => {
...
fdescribe('#core #webpadize withJsonMetadata', () => {
