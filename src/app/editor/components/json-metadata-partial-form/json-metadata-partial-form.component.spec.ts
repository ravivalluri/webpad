...
@Component({
  ...
  template: `
    <app-json-metadata-partial-form
      ...
      [currentwebpadPost]="currentwebpadPost"
    >
    </app-json-metadata-partial-form>
  `
})
...
fdescribe('#EditorModule JsonMetadataPartialFormComponent', () => {
  ...
  it('#currentMetadata should be an object created based on `(core)createJsonMetadata` + all props of `currentwebpadPost` if `jsonMetadataControl` is valid', () => {
    component.jsonMetadataControl.setErrors(null);
    component.currentwebpadPost = {
      ...component.currentwebpadPost,
  ...
  // tslint:disable-next-line:max-line-length
  it('#currentMetadata should be an object created based on `(core)createJsonMetadata` + all props of `currentwebpadPost` except `jsonMetadata`, if `jsonMetadataControl` is invalid', () => {
